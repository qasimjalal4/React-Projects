...
export function Home() {
  return (
    <>
     <div className='mx-auto max-w-md mt-12 flex justify-center flex-col items-center'>
       <h1 className="text-3xl font-bold text-gray-900 mb-8 text-center">
        Welcome to Home Page
       </h1>
       <p className="text-lg text-gray-900 mb-4 leading-relaxed text-center">
        This is a simple React Router demo showing how navigation works between pages.
       </p>
       <p className="text-lg text-gray-900 mb-12 leading-relaxed text-center">
